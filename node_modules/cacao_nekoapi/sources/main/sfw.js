...
class SFW {
    ...
    static action_2 = {
        ...
        hug(id) {
            if(id) {
                if(typeof(id) !== "number") throw new nekoError(actionData.className, actionData.errorMsg)
                return RestApi2.exec('action', "hug", id)
            } else {
                return RestApi2.exec('action', "hug")
            }
        },
        /**
         * @param {number} id  
        ...
        hi(id) {
            if(id) {
                if(typeof(id) !== "number") throw new nekoError(actionData.className, actionData.errorMsg)
                return RestApi2.exec('action', "hi", id)
            } else {
                return RestApi2.exec('action', "hi")
            }
        },
        /**
         * @param {number} id  
        ...
        handwashing(id) {
            if(id) {
                if(typeof(id) !== "number") throw new nekoError(actionData.className, actionData.errorMsg)
                return RestApi2.exec('action', "handwashing", id)
            } else {
                return RestApi2.exec('action', "handwashing")
            }
        }
    }
    /**
    ...
    static reaction_2 = {
        ...
        explosion(id) {
            if(id) {
                if(typeof(id) !== "number") throw new nekoError(reactionData.className, reactionData.errorMsg)
                return RestApi2.exec('reaction', "explosion", id)
            } else {
                return RestApi2.exec('reaction', "explosion")
            }
        }
    }
    /**
