declare module "cacao_nekoapi" {
    ...
    export class RestApiv1 extends Messages {
         ...
         * @param name
         */
        static action(name: string): Promise<Rest1.UrlResult> // recibe una promesa con el link de la imagen que solicitaste
        /**
         * Nombre del gif que quieres obtener
         * @param name
         */
    ...
    export class SFW {
        ...
        static action_2: {
            ...
            /**
             * Metodo hug para gifs de abrazos
             * @param id id del gif
             */
            hug(id?: number): Promise<rolplaySeach.UrlResult>
            /**
             * Metodo hi para gifs de saludo
             * @param id id del gif
             */
            hi(id?: number): Promise<rolplaySeach.UrlResult>
            /**
             * Metodo handwashing para gifs de lavarse las manos
             * @param id id del gif
             */
            handwashing(id?: number): Promise<rolplaySeach.UrlResult>
        }
        /**
        ...
        static reaction_2: {
            ...
            /**
             * Metodo explosion para gifs de explotar
             * @param id id del gif
             */
            explosion(id?: number): Promise<rolplaySeach.UrlResult>
        }
        /**
